...
public interface WbvillagesRepository extends JpaRepository<WbVillageMastEntity, Integer> {
	...
	@Query(value="select wbvcode,wbvname from wbvillage_mst where wbmcode=:mandCode order by wbvname ",nativeQuery=true)
	public List<WbVillageMastProjection> getVillNameByMand(@Param("mandCode") Integer mandCode);
