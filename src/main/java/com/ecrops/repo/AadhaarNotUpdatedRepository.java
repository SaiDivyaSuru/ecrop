...
public interface AadhaarNotUpdatedRepository extends JpaRepository<AadhaarNotUpdated, String>{
	@Query(value="select wb.wbemname as lgdmname,vname from user_registration u, wbvillage_mst wb,vill_sec_det vi \r\n"
			...
			+ "group by blockortehsil, village,lgdmname,vname,wb.wbemname order by wb.wbemname,vname",nativeQuery=true)
