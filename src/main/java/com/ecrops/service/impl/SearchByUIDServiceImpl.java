...
public class SearchByUIDServiceImpl implements SearchByUIDService{
	...
	public List<SearchByUIDModel> getSearchByUIDdet(String tname, String userid, String aNo) {
		...
		+ "  bookingid, kh_no,vaaauth,vroauth,coalesce (to_char(dt_vaaauth,'yyyy-mm-dd'),' ') as dt_vaaauth,coalesce (to_char(dt_vroauth,'yyyy-mm-dd') , ' ') as dt_vroauth,"
		+ "  coalesce ( to_char(dt_ekyc,'yyyy-mm-dd'), ' ') as dt_ekyc, cultdesc  , varietyname, cr_sno,cr_mix_unmix_ext,"
