...
public class GetCropYearServiceImpl implements GetCropYearService{
	...
	public List<AllocationSurveyNoModel> getAllSurveryNos(String t1, Integer mcode, String userid, Integer cropyear1, String season) {
		...
		if (cropyear1 >= 2023  ) {
			sql = "select wbevname as lgdvname,cast(kh_no as character varying) as kh_no,cr_sno,coalesce (cast(tot_extent as character varying) , '0') as tot_extent,coalesce(geo_reffered,' ') as geo_reffered,\r\n"
