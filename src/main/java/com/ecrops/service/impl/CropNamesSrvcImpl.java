...
//		getcropnames.setCropname((String)row[1].toString());
	...
	String sql = "select cropid,cropnameeng as cropname from cropnames  where active='A' and cropclass in ('P','B') order by cropname";	
...
//		getcropnames.setCropname((String)row[1].toString());
	...
	@Override
	public String getCropnameForCropid(Integer cropId) {
		// TODO Auto-generated method stub

		 String sql = "select cropname from cropnames where cropid = :cropId";
		    ...
		    try {
		        ...
		        return null; // Return null if no cropname found for the given cropid
		    }		
