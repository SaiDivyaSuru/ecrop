...
@PreAuthorize("hasAuthority('17') || hasAuthority('48')  ")
@Controller
...
//	======================DistWiseVAAVROeKYCrabi=================
	...
	//=================================NormalArea====================
		@GetMapping("/normarearep")
			public String normarearep(HttpSession httpSession,Model model) {
			String dcode = (String) httpSession.getAttribute("dcode");
			List<DistrictProjections> dist = distrepo.getList();
			System.out.println("dist" + dist.size());
...
//	======================DistAgriHortiFishDDAP================
	...
	public String getcrpMao(Model model, HttpSession session) {
		...
		return "ddap/CropBookingDetailsDDAPIntf";
