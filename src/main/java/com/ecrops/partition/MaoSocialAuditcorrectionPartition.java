...
public class MaoSocialAuditcorrectionPartition {
	...
	public List<MaoSocialAuditcorrection> getSocialAudit(String wbdcode,String dcode, String mcode, String cropyear ){
		...
		String Sql = " select wbvname,farmername,crop,variety,extent,src_irr,cr_pattern,cast( sow_date as varchar) as sow_date,farming_type,vaadeleted ,tot_corrections,totbookings,\r\n"
		...
		for (Object[] row : detailsEntities1) {
			...
			entity.setSow_date((String) row[7].toString()); 
