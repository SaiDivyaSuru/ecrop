...
public class FarmerDetailsPartition {
	...
	public List<FarmerDetails> farmerDetails(String wbdcode, String cropyear, String wbmcode, String datee,String vcode) {
...
//				+ "";
		String Sql = "select wbmname,wbvname,occupname,occupfname,cr_sno,cropname,varietyname, bookedext, TO_CHAR(cr_sow_date, 'DD/MM/YYYY') AS cr_sow_date,mobileno,kh_no,caste\r\n"
				...
				+ " where cr_mand_code="+Integer.parseInt(wbmcode)+"  and cr_vcode="+Integer.parseInt(vcode)+" ";
