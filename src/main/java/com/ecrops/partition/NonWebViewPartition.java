...
public class NonWebViewPartition {
	...
	public List<NonWebView> getNonwebView(String dcode, String mcode, String cropyear,String vcode) {
		...
		String Sql = "select cast(kh_no as character varying) as kh_no,cr_sno,oc_name,oc_fname,occupname,occupfname,\r\n"
				...
				+ " and a.dcode=? and a.mcode=?  and cr_season=? and cr_year=? and a.cr_vcode=? order by wbdname,wbmname,wbvname ";
		...
		insertQuery.setParameter(5,Integer.parseInt(vcode));
