...
public class CCRCCropData {
	...
	@JsonProperty("owner_aadhaar")
	private String owner_aadhaar;

	
	public String getOwner_aadhaar() {
		return owner_aadhaar;
	}

	public void setOwner_aadhaar(String owner_aadhaar) {
		this.owner_aadhaar = owner_aadhaar;
	}
	...
	public CCRCCropData(String ccrc_id, String doc_Id, String district, String dName, String mandal, String mName,
			...
			String webland_Occupant_Father_Name,String owner_aadhaar) {
		super();
	...
	public String toString() {
		return "CCRCCropData [ccrc_id=" + ccrc_id + ", Doc_Id=" + Doc_Id + ", District=" + District + ", DName=" + DName
				...
				+ ", webland_Occupant_Father_Name=" + webland_Occupant_Father_Name + ",owner_aadhaar=" + owner_aadhaar +" ]";
	}
}