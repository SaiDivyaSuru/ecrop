...
public class CLSCrPestImagesEntity {
	...
	public Integer getCr_pestcode() {
		return cr_pestcode;
	}

	public void setCr_pestcode(Integer cr_pestcode) {
		this.cr_pestcode = cr_pestcode;
	}
