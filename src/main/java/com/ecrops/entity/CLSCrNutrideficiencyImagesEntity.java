...
@Entity
@Table(name = "cr_nutrideficiency_images", schema = "cropimages")
public class CLSCrNutrideficiencyImagesEntity {
	...
	@Id
	private Integer cr_nutrientcode;
	...
	public Integer getCr_nutrientcode() {
		return cr_nutrientcode;
	}

	public void setCr_nutrientcode(Integer cr_nutrientcode) {
		this.cr_nutrientcode = cr_nutrientcode;
	}
