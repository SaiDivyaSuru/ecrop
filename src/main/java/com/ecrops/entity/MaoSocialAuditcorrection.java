...
public class MaoSocialAuditcorrection {
	...
	public MaoSocialAuditcorrection(String wbvname, BigInteger farmername, BigInteger crop, BigInteger variety, BigInteger extent, BigInteger src_irr,
			BigInteger cr_pattern, String sow_date, BigInteger farming_type, BigInteger vaadeleted, BigInteger tot_corrections, BigInteger totbookings,
	...
	public String getSow_date() {
		return sow_date;
	}
	public void setSow_date(String sow_date) {
		this.sow_date = sow_date;
	}
