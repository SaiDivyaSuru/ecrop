...
@Entity
@Table(name = "cr_disease_images", schema = "cropimages")
public class CLSCrDiseaseImagesEntity {
	...
	@Id
	private Integer cr_diseasecode;
	...
	public Integer getCr_diseasecode() {
		return cr_diseasecode;
	}

	public void setCr_diseasecode(Integer cr_diseasecode) {
		this.cr_diseasecode = cr_diseasecode;
	}
